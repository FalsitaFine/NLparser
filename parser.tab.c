...
{
  "$end", "error", "$undefined", "NOUN", "VERB", "ADJ", "ADV", "$accept",
  "paragraph", "sentence", "noun", "verb", "adj", "adv", YY_NULLPTR
};
#endif
...
{
       5,     8,     7,     5,    16,     1,    14,     2,     1,     9,
       2,    10,    15,     1,     0,     2,     9,     0,    10
};

static const yytype_int8 yycheck[] =
{
       0,     3,     0,     3,    13,     3,     6,     5,     3,     4,
       5,     6,    12,     3,    -1,     5,     4,    -1,     6
};
...
#line 58 "parser.y" /* yacc.c:1646  */
    {
	char * strc = (char *) malloc(2 + strlen((yyvsp[-1].str))+ strlen((yyvsp[0].str)) );
	strcpy(strc, (yyvsp[-1].str));
	strcat(strc, " ");
	strcat(strc, (yyvsp[0].str));
	(yyval.str) = strc;

	printf("Recognize (Adj)%s (Noun)%s as Noun %s\n", (yyvsp[-1].str), (yyvsp[0].str), (yyval.str));
}
